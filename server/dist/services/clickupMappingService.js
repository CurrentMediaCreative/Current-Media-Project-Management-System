...
exports.ClickUpMappingService = void 0;
const clickup_1 = require("../../../shared/src/types/clickup");
class ClickUpMappingService {
    static mapTaskToProject(task) {
        return {
            id: task.id || '',
            name: task.name || '',
    ...
    static extractCustomFieldValue(task, fieldKey) {
        const fieldId = clickup_1.CLICKUP_FIELD_MAPPING[fieldKey];
...
exports.ClickUpMappingService = ClickUpMappingService;
exports.default = new ClickUpMappingService();
//# sourceMappingURL=clickupMappingService.js.map